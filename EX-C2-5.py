...
HR_LOWER_THRESHOLD = int(input("    ⚙️ Lower HR threshold for this profile (e.g. 40): "))
HR_UPPER_THRESHOLD = int(input("    ⚙️ Upper HR threshold for this profile (e.g. 120): "))
ABP_LOWER_THRESHOLD = int(input("   ⚙️ Lower ABP threshold for this profile (e.g. 60): "))
ABP_UPPER_THRESHOLD = int(input("   ⚙️ Upper ABP threshold for this profile (e.g. 140): "))
